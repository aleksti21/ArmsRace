...
object LobbyManager {
    ...
    fun removePlayer(player: ServerPlayer): MutableComponent {
        ...
        val world = player.serverLevel().server.getLevel(ResourceKey.create(Registries.DIMENSION, ResourceLocation(spawn.world))) ?: player.serverLevel().server.getLevel(ResourceKey.create(Registries.DIMENSION, ResourceLocation("minecraft:overworld")))
